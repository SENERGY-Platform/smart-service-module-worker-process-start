module github.com/SENERGY-Platform/smart-service-module-worker-process-start

go 1.25.0

require github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20260302073741-e7f1bb7c9def

require (
	github.com/KyleBanks/depth v1.2.1 // indirect
	github.com/SENERGY-Platform/camunda-engine-wrapper v1.0.14 // indirect
